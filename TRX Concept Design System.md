...
Single-page lead generation site for a personal TRX trainer in Santiago, Chile. Built with HTML, custom CSS, and Bootstrap 5.3 as a utility layer. Language: Spanish (es).
...
- `< 768px`: logo font shrinks to `2.2rem`
- `< 576px`: logo hides; header logo image grows to `6rem`; comparison table font shrinks to `0.8em`, padding tightens to `0.3rem`
...
### Header
Yellow (`#ffd700`) sticky bar. Flex row: logo image + wordmark (Impact) + `.btn-whatsapp` CTA. Logo image height: `5rem` (desktop), `6rem` (mobile).
